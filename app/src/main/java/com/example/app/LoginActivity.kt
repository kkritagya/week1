...
//             textDecoration = TextDecoration.Underline
        ...
        Row(modifier = Modifier.fillMaxWidth(),
            ...
            Image(
                painter = painterResource(R.drawable.fd),
                contentDescription = null,
        ...
        Column(modifier = Modifier.padding(horizontal = 10.dp, vertical = 15.dp)) {
            ...
            Text("Designer")
            Text("kritagyak@gjmv.vom")
            Text("Followed by xyz and abc")
        ...
        Row (
            ...
            Button(onClick =  { },
                //user le thiche pachi k garne/ to-do when clicked
            ...
            OutlinedButton(onClick =  { }, //user le thiche pachi k garne/ to-do when clicked
                shape=  RoundedCornerShape(10.dp),
